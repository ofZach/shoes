...
import com.example.android.TalkingShoes.R;
...
public class BluetoothChat extends Activity implements View.OnClickListener, View.OnTouchListener{
    ...
    protected static final String ShareActivityTAG = "ShareActivity";
    ...
    private String lastMessageBuffer; //for holding partial messages
    ...
    private void setupChat() {
        ...
        //initialize share button for google+
    ...
    void gPlusShare(){
        ...
        if (errorCode == GooglePlusUtil.SUCCESS) {
        	...
        	//postMessage = "TEST MESSAGE FROM SHOE";
        	String thumbnailUri = "http://news.cnet.com/i/bto/20090303/796589328_1fd20df357.jpg";
        	String metadataTitle = "Talking Shoe App";
        	String metadataDescrip = "Project by Google, 72andSunny, and YesYesNo";
            Uri thumbnail = Uri.parse(thumbnailUri);
                    //getString(R.string.plus_deep_link_metadata_thumbnail_url));
...
//                String msgRaw = msg.obj.toString();
//                Log.d(TAG, "msgRaw: " + msgRaw);
                String msgArg1 = Integer.toString(msg.arg1);
                Log.d(TAG, "msg.arg1: " + msgArg1);
                String msgWhat = Integer.toString(msg.what);
                Log.d(TAG, "msg.what: " + msgWhat);
                
                // construct a string from the valid bytes in the buffer
                String readMessage = new String(readBuf, 0, msg.arg1);
                //check that we got the entire string (with end char of ".")
                if(readMessage.endsWith(".")) { 
                	String completeMsg = lastMessageBuffer + readMessage;
                	postMessage = completeMsg; // set global post message to this completeMsg
                	Log.d(TAG, readMessage);
                	lastMessageBuffer = "";
                	mConversationArrayAdapter.add(mConnectedDeviceName+":  " + completeMsg);
                	
                	gPlusShare();
                	
                } else lastMessageBuffer = readMessage;
                break;
